...
// Entry
$_['entry_title']       = 'Onderwerp:<br /><span class="help">Naam van de pagina zoals deze wordt weergegeven in de winkel.</span>';
$_['entry_description'] = 'Bericht:<br /><span class="help">Inhoud (content) van de pagina zoals deze wordt weergegeven in de winkel.</span>';
$_['entry_store']       = 'Winkel(s):<br /><span class="help">In welke winkel(s) is deze pagina zichtbaar?</span>';
...
$_['error_store']       = 'Waarschuwing: Deze informatie-pagina kan niet verwijderd worden omdat deze door %s winkel(s) wordt gebruikt!';
?>